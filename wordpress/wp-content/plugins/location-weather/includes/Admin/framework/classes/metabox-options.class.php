	...
	class SPLWT_Metabox extends SPLWT_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			if ( 'location_weather' === $the_current_post_type && $preview_show ) {
				...
				echo '<div class="splwt-submit-options"><a href="https://shapedplugin.com/support/" target="_blank"><i class="fa fa-life-ring"></i> Support</a></div>';
				echo '</div>'; ?>
		...
		<div class="splw-after-copy-text"><i class="fa fa-check-circle"></i> Shortcode Copied to Clipboard! </div>
		<div class="splw_shortcode_content">
			<h2 class="splw-shortcode-title"><?php echo esc_html__( 'Gutenberg Block', 'location-weather' ); ?> </h2>
			<p><?php echo esc_html__( 'Location Weather block to insert a weather shortcode in your page:', 'location-weather' ); ?></p>
			<div class="splw-code ">
				<img class="lw-gutenberg-block" src="<?php echo esc_url( LOCATION_WEATHER_ASSETS ) . '/font/lw-gutenberg-block.svg'; ?>" alt="">
			</div>
		</div>
	</div>
	<div class="splw-col-lg-3">
		<div class="splw_shortcode_content">
			...
			<div class="splw-code selectable">
				<div class="splw-copy">&lt;?php echo do_shortcode('[location-weather id="<?php echo esc_attr( $post->ID ); ?>"]');?&gt;</div>
			</div>
		</div>
	</div>
</div>
