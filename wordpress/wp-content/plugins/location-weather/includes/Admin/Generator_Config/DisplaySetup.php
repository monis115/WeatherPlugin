			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'help'       => __( 'For 24 format, you have to set the Date Format like this \'H:i, F j, Y\'', 'location-weather' ),
						'options'    => array(
					...
					array(
						...
						'type'    => 'select',
						'title'   => 'Forecast Days',
						'desc'    => __( 'To unlock the forecasting weather settings, <a href="https://shapedplugin.com/plugin/location-weather/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'location-weather' ),
						'options' => array(
